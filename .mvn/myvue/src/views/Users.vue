          ...
          <el-menu :default-openeds="['1', '3']"  style="margin-right: 10px">
            <el-submenu index="1">
              ...
              <el-menu-item-group>
                ...
                <el-menu-item index="1-2" @click="$router.push('/home')">主页</el-menu-item>
                <el-menu-item index="1-2" @click="$router.push('/person')">个人资料</el-menu-item>
                <el-menu-item index="1-1" @click="this.$router.go(0)">用户管理</el-menu-item>
              </el-menu-item-group>
...
<!--&lt;!&ndash;              <el-upload class="upload-demo" action="http://localhost:8081/students/import" accept="xlsx" :show-file-list="false" :on-success="handleSuccessInUpload">&ndash;&gt;-->
<!--&lt;!&ndash;                <el-button size="mid" type="" style="margin: 10px 10px">点击上传</el-button>&ndash;&gt;-->
...
export default {
  ...
  methods:{
    ...
    delete(id){
      console.log(id)
      request.delete("http://localhost:8081/user/delete",{
        params:{
          id:id,
        }
      }).then(res=>{
